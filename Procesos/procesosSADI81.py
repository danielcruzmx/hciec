from SadiCarnot81.models import AcumuladoMes, CuotasCondominio, Movimiento, Condomino, Registro
...
def run_acumMes_SADI81(condominio):
	print(" generando acumulados %s " % condominio)
	with transaction.atomic():
		#
		#Borra acumulados
		borrado = 'delete from sadiochouno_acumulado_mes'
		nq1 = 9
		nq2 = 10		
		#
		n = execsql(borrado)
